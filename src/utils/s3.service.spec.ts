...
describe('S3Service', () => {
    ...
    describe('uploadDocument', () => {
        it('should upload a document successfully', async () => {
            ...
            await service.uploadDocument('test-bucket', 'test-file.pdf', Buffer.from('test'));
    ...
    describe('readJsonFileFromS3', () => {
        it('should read and parse JSON from S3', async () => {
            ...
            const result = await service.readJsonFileFromS3('test-bucket', 'test.json');
    ...
    describe('getFileBufferFromS3', () => {
        it('should return a buffer from S3 object', async () => {
            ...
            const result = await service.getFileBufferFromS3('test-bucket', 'test.pdf');
